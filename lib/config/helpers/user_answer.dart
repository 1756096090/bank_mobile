...
class UserAnswer {
  ...
  Future<dynamic> getUserByIdAndPassword(BuildContext context, String mail, String password) async {
...
Future<dynamic> createUser(String name, String mail, String password, String phone, String dni ) async {
